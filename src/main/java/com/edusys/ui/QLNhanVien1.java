 ...
 */
public class QLNhanVien1 extends javax.swing.JDialog {
     ...
     */
    public QLNhanVien1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    void fillToTable() {
        ...
        model.setRowCount(0);
        try {
            List<NhanVien1> list = nvDao.selectAll();
    ...
    void edit() {
        try {
            ...
            NhanVien1 model = nvDao.selectById(maNV);
            if (model != null) {
                setForm(model);
                updateStatus();
    ...
    NhanVien1 getForm() {
        NhanVien1 model = new NhanVien1();
        model.setMaNV(txtMaNV.getText());
        model.setHoTen(txtHoTen.getText());
        model.setMatKhau(new String(txtMatKhau.getPassword()));
        model.setSoDT(Integer.parseInt(txtSoDT.getText()));
    ...
    void xoa(){
        if(!Auth.isManager()){
            MsgBox.alert(this, "Bạn chưa đủ quyền hạn để xóa nhân viên!");
        }else{
...
//    btnLast
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(txtSoDT, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(29, 29, 29))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Nhân Viên", "Mật Khẩu", "Họ Tên", "Số Điện Thoại", "Vai trò"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLNhanVien1 dialog = new QLNhanVien1(new javax.swing.JFrame(), true);
